...
Distributed under the **MIT License**. See the [LICENSE](https://github.com/it-at-m/agile-test-automation-framework/blob/main/LICENSE) file for more information.

## Contact

For questions, issues, or suggestions, please use the [repository issue tracker](https://github.com/it-at-m/agile-test-automation-framework/issues) or [discussions](https://github.com/it-at-m/agile-test-automation-framework/discussions) section.
