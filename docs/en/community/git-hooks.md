...
Hook scripts live in [`.husky/`](https://github.com/it-at-m/agile-test-automation-framework/tree/main/.husky) (`pre-commit`, `commit-msg`).
...
The ticket number is **optional** — use `ATAF-123` or just `ATAF` (uppercase).

**Valid types:** `feat`, `fix`, `clean`, `chore`, `docs`

**Valid projects:** `ATAF`, `GH`
...
- [Contributing and License](./contributing.md)
